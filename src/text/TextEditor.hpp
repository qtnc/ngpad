...
virtual void OnCharHook (wxKeyEvent& e);
virtual bool OnCopy (wxClipboardTextEvent& e);
virtual void OnCut (wxClipboardTextEvent& e);
virtual void OnPaste (wxClipboardTextEvent& e);
virtual void OnEnter ();
virtual void OnCtrlEnter ();
virtual void OnTab ();
virtual void OnShiftTab ();
virtual void OnHome ();
virtual void OnShiftEnd ();
virtual void OnCtrlShiftEnd ();
